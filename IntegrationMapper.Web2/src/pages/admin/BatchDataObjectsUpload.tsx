...
export function BatchDataObjectsUpload() {
    const { token } = useAuth()
  ...
  "dataObjects": [
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/admin/dataobjects/batch', {
                method: 'POST',
                headers: {
        ...
        <div className="h-full overflow-auto">
            <div className="max-w-4xl mx-auto p-6">
                <div className="flex items-center gap-2 text-sm text-slate-500 mb-4">
                    ...
                    <span>/</span>
                    <span>Batch Data Objects Upload</span>
                </div>

                <PageHeader
                    title="Batch Data Objects Upload"
                    description="Upload data objects with schemas and examples"
                />
                ...
                <div className="mt-6 space-y-4">
                    ...
                    <textarea
                        ...
                        className="w-full h-64 p-4 font-mono text-sm bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
                        placeholder="Paste your JSON here..."
                    />

                    <div className="flex gap-3">
                        <Button onClick={handleSubmit} disabled={isLoading || !jsonInput.trim()}>
                            {isLoading ? 'Uploading...' : 'Upload Data Objects'}
                        </Button>
                    </div>
