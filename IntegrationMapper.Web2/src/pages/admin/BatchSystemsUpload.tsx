...
export function BatchSystemsUpload() {
    const { token } = useAuth()
  ...
  "systems": [
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/admin/systems/batch', {
                method: 'POST',
                headers: {
        ...
        <div className="h-full overflow-auto">
            <div className="max-w-4xl mx-auto p-6">
                <div className="flex items-center gap-2 text-sm text-slate-500 mb-4">
                    ...
                    <span>/</span>
                    <span>Batch Systems Upload</span>
                </div>

                <PageHeader
                    title="Batch Systems Upload"
                    description="Upload multiple systems at once using JSON format"
                />
                ...
                <div className="mt-6 space-y-4">
                    ...
                    <div className="flex gap-3">
                        <Button onClick={handleSubmit} disabled={isLoading || !jsonInput.trim()}>
                            {isLoading ? 'Uploading...' : 'Upload Systems'}
                        </Button>
                    </div>
